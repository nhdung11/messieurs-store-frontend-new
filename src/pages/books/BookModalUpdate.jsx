...
import { callBulkCreateUser, callCreateBook, callFetchCategory, callUpdateBook, callUploadBookImg } from '../../services/apis';
import { LoadingOutlined, PlusOutlined } from '@ant-design/icons'
import { v4 as uuidv4 } from 'uuid'
const BookModalUpdate = (props) => {
    const { openModalUpdate, setOpenModalUpdate, dataBookDetail, fetchBooks } = props;
    ...
    useEffect(() => {
        if (dataBookDetail?._id) {
            ...
            const arrSlider = dataBookDetail?.slider?.map(item => {
                return {
                    uid: uuidv4(),
                    name: item,
                    status: 'done',
            ...
            const init = {
                ...
                category: dataBookDetail.category,
                author: dataBookDetail.author,
                mainText: dataBookDetail.mainText,
                price: dataBookDetail.price,
                quantity: dataBookDetail.quantity,
                sold: dataBookDetail.sold,
    ...
    const onFinish = async (values) => {
        ...
        console.log("????: ", mainText, author, category, price, quantity, sold, thumbnail, slider)
        ...
        console.log("Res updated book: ", res)
        return;
    };
            ...
            >
                ...
                >
                    <Row gutter={15}>
                        ...
                        <Col span={window.innerWidth >=768 ? 6 : 12}>
                            <Form.Item
                                labelCol={{ span: 24 }}
                                label="Giá tiền"
                                name="price"
